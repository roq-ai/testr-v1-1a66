...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Accesses', path: '/accesses', entity: 'access', service: AccessServiceEnum.PROJECT, icon: FiUnlock },
    {
      name: 'Notifications',
      path: '/notifications',
      entity: 'notification',
    ...
    { name: 'Shares', path: '/shares', entity: 'share', service: AccessServiceEnum.PROJECT, icon: FiShare2 },
