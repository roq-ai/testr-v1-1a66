...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Testr v1`}</title>

        <meta
          name="description"
          content="Testr v1: Empowering you to share knowledge, effortlessly. Upload, share and control access to PDFs. Set expiry dates and receive notifications. Welcome to a world of seamless document sharing."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1553484771-371a605b060b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwZGZ8ZW58MHx8fHwxNjk1NzY1MDQ0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Testr v1: Empowering you to share knowledge, effortlessly. Upload, share and control access to PDFs. Set expiry dates and receive notifications. Welcome to a world of seamless document sharing.`}
            </Text>
            <Box
