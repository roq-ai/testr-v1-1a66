...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_placed.create': { roles: ['owner', 'administrator'], key: 'order', tenantPath: [], userPath: [] },
  'pricing_updated.update': { roles: ['owner', 'administrator'], key: 'pricing', tenantPath: [], userPath: [] },
  'product_added.create': { roles: ['owner', 'administrator'], key: 'product', tenantPath: [], userPath: [] },
};
